...
export default async function GuidePage({
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Cabecera noir */}
      <header className="bg-[var(--noir)] px-6 pb-16 pt-36 text-[var(--ivory)]">
        <div className="mx-auto max-w-3xl">
          <Link
            href="/guias"
            className="mb-8 inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[var(--ivory)]/60 transition-colors hover:text-[var(--gold)]"
          >
            ← Todas las guías
          </Link>
          <div className="mb-5 flex items-center gap-3">
            <span className="text-xs uppercase tracking-[0.2em] text-[var(--gold)]">{guide.category}</span>
            <span className="text-xs text-[var(--ivory)]/40">·</span>
            <span className="text-xs uppercase tracking-[0.2em] text-[var(--ivory)]/60">{guide.region}</span>
          </div>
          <h1 className="font-serif text-4xl font-light leading-[1.1] text-balance md:text-5xl">{guide.title}</h1>
          <p className="mt-6 flex items-center gap-4 text-xs uppercase tracking-[0.2em] text-[var(--ivory)]/50">
      ...
      <article className="px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          {/* Aviso */}
          <p className="mt-16 border-l-2 border-[var(--gold)] pl-5 text-sm italic leading-relaxed text-muted-foreground">
      ...
      <section className="bg-[var(--noir)] px-6 py-20 text-center text-[var(--ivory)]">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-5 text-base leading-relaxed text-[var(--ivory)]/70">
            Conversa con un asesor para entender qué activos validados encajan con tu perfil y objetivos de inversión.
          </p>
          <Link
            href="/asistente"
            className="mt-8 inline-flex items-center justify-center gap-2 border border-[var(--gold)] bg-[var(--gold)] px-9 py-4 text-xs uppercase tracking-[0.2em] text-[var(--noir)] transition-colors hover:bg-transparent hover:text-[var(--gold)]"
          >
